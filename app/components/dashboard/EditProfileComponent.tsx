...
export default function EditProfileComponent() {
  ...
  useEffect(() => {
    setLoading(true);
    UserApis.getCurrentUserProfile().then((res) => {
      setUser(res);
                ...
                <div className='md:basis-2/3'>
                  <div className='flex flex-col mb-6 md:max-w-[650px]'>
                    ...
                    <div className='shadow-sm rounded flex'>
                      <div
                        className='px-6 py-3 dark:text-gray-100 flex items-center bg-[#F8F8F8] !border-[#6b7280] border border-solid box-border border-r-0 rounded-l'>
                        <svg xmlns='http://www.w3.org/2000/svg' className='icon icon-tabler icon-tabler-mail' width={20}
                      ...
                      <input {...register('email')} type='email' defaultValue={user?.email} id='Email' name='email'
                    ...
                    <div>
                      {user?.email_verified ? (
                        ...
                        <div className='flex items-center pt-1 text-amber-800 mt-1'>
                          ...
                          <button
                            className='text-xs text-blue-600 hover:text-blue-900 hover:underline hover:underline-offset-1 ml-2'>
                  ...
                  <div className='flex flex-col mb-6 md:max-w-[650px]'>
                    <label htmlFor='FullName' className='pb-2 text-sm text-gray-800 dark:text-gray-100'>
                      Full name:
                    </label>
                    <div className='shadow-sm rounded flex'>
                      <input
                  ...
                  <div className='flex flex-col mb-6 md:max-w-[650px]'>
                    ...
                    <div className='rounded flex'>
                      <select {...register('gender')} id='Gender' name='gender' defaultValue={user?.gender}
                  ...
                  <div className='flex flex-col mb-6 md:max-w-[650px]'>
                    ...
                    <div className='shadow-sm rounded flex'>
                      ...
                      <input {...register('phone')} type='tel' defaultValue={user?.phone} id='Phone' name='phone'
                             className='pl-3 py-3 w-full text-sm focus:outline-none placeholder-gray-500 bg-transparent text-gray-500 dark:text-gray-400 rounded-r'
                             placeholder='example@gmail.com' />
                    </div>
                    <div className='flex items-center pt-1 text-green-400 mt-1'>
