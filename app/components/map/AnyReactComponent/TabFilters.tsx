...
const TabFilters = () => {
          ...
          <>
            ...
            >
              <Popover.Panel className="absolute z-20 w-screen max-w-sm px-4 mt-3 left-0 sm:px-0">
                <div className="rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 custom-translate">
            ...
            <div className="min-h-screen text-center">
              ...
              >
                <div className="inline-flex flex-col w-full max-w-4xl text-left align-middle transition-all transform rounded-2xl bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 dark:text-neutral-100 shadow-xl h-full">
                  ...
                  <div className="p-6 flex-shrink-0 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between rounded-b-xl">
                    <ButtonThird
  ...
  const renderTabMoreFilterMobile = () => {
    return (
      <div>
        <div
          className={`flex lg:hidden items-center justify-center px-4 py-2 text-sm border border-primary-500 bg-primary-50 text-primary-700 focus:outline-none cursor-pointer`}
