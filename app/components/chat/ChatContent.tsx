...
export default function ChatContent() {
  return (
    <div className="w-[837px] h-[620px] bg-blue-100 flex flex-col  ">
      <div className="flex-grow overflow-y-auto">
        ...
        <div className="flex flex-row items-center px-2 mb-50">
          <img
            src="./images/resort1.jpg"
            className="w-10 h-10 rounded-full mr-2"
            alt=""
      ...
      <div className="flex flex-row items-center  rounded-lg px-3 py-2 mx-3 mb-3">
        ...
        <input
          ...
          className="w-full h-10 px-1 border border-gray-500 rounded-lg mr-3"
        />
