    ...
    <Fragment>
      <div className="bg-resort-banner bg-cover bg-no-repeat bg-center flex items-center py-64 justify-center relative opacity-80">
        <div className="bg-white rounded-3xl w-full flex-row z-20 grid absolute mt-24 md:mt-24 md:w-full lg:grid-cols-4 lg:w-auto lg:mx-5 xl:grid-cols-4 xl:w-[1200px] lg:mt-36 xl:mt-36 ">
          ...
          <div onClick={handleVisibleCalendar} className="flex flex-col  xl:p-6 px-3 py-3">
          ...
          <div
            onClick={() => handleSubmitSearchApartment(resortId, dateRange, totalGuest)}
            className="bg-common md:rounded-r-3xl md:rounded-l-3xl rounded-b-3xl py-5 flex flex-col justify-center items-center text-white hover:cursor-pointer hover:bg-sky-500"
          >
